...
<div class="row" style="padding: 60px 47px;">
    <div class="card" style="width: 100%;">
        <div class="card-header">
            <a style="float:right" class="btn btn-success" href="{{ route('healthUnits.create') }}">Adicionar <i class="fas fa-plus-circle"></i></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body" >
                ...
                <tr>
                    ...
                    <td><a style="font-size: 24px; color: #0552ff;" href="{{ route('healthUnits.edit', ['healthUnit' =>  $healthUnit->id ]) }}">
                        ...
                        <a style="font-size: 24px; color: red;"
                            href="#confirmModal" data-id-categoria="{{ $healthUnit->id }}"
                            data-toggle="modal">
...
@section('scripts')
    <script>
        $('#confirmModal').on('show.bs.modal', function(e) {
            ...
            $('#form-delete-categoria').attr('action', '/admin/healthUnits/' + idCategoria);
        });
